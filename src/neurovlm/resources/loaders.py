...
from neurovlm.models.base import NeuroAutoEncoder, ProjHead, Specter
from neurovlm.models.qformer import NeuroQFormer
from neurovlm.models.serialization import load_model
...
def _ale_only_cache_filename(
    ...
    *,
    ...
    """Return the uploaded ALE-only cache filename for legacy notebooks."""
...
def _load_cnn_autoencoder(variant: str = "mixed") -> torch.nn.Module:
    ...
    from neurovlm.cnn.models import autoencoder_from_payload
