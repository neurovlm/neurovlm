...
For CNN branches, `mixed_baseline` is the default; `finetuned` must be requested explicitly. Prefer released initialization, and use `from_run` only for deliberate local chaining. See `docs/experimental/cnn/technical_guide.md` for task examples.
