...
from neurovlm.data.loaders import load_dataset, load_latent, load_masker
...
class NeuroVLM:
        ...
        for dataset in datasets:
            if dataset not in self._text_raw_embeddings:
                if dataset == "networks":
                    ...
                    from neurovlm.resources.loaders import _load_latent_ngram, _load_ngram
    ...
    def _ensure_generative_text_model(
        ...
        *,
        ...
        from neurovlm.resources.loaders import NEURO_QWEN_REPO_ID, _load_neuro_qformer
    ...
    def _generate_brain_to_text_response(
        ...
        """
        from neurovlm.retrieval.summarization import generate_response as _gen_response
