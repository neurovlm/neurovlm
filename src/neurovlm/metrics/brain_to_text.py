...
from neurovlm.data.loaders import load_dataset, load_latent
from neurovlm.metrics.common import (
    as_latent_batch,
    project_brain_latents_to_shared,
    project_text_latents_to_shared,
)
from neurovlm.metrics.retrieval import normalized_k_values, normalized_recall_curve_auc
...
def run_paper_retrieval_eval(
    *,
    ...
    from neurovlm.metrics.semantic import (
