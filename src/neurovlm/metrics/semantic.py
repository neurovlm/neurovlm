...
from neurovlm.metrics.retrieval import normalized_recall_curve_auc, retrieval_ranks
...
def load_network_maps(path: str | Path | None = None) -> list[dict[str, Any]]:
    ...
    if path is None:
        from neurovlm.resources.loaders import _load_networks
...
def load_network_label_table(path: str | Path | None = None) -> pd.DataFrame:
    ...
    if path is None:
        from neurovlm.data.loaders import load_dataset
